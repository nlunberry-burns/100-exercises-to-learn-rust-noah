...
impl From<&u8> for SaturatingU16 {
    fn from(u: &u8) -> SaturatingU16 {
        let x = *u;
        SaturatingU16 { value: x.into() }
    }
}

//It should support addition with a right-hand side of type SaturatingU16, u16, &u16, and &SaturatingU16. Addition should saturate at the maximum value for `u16`.
